...
const DeleteDocument = ({ setOpen, modalObj }) => {
    return (
        <>
            <div
                onClick={(event) => {
                ...
                <div className="bg-white p-6 rounded-[10px] material-shadow">
                    <div className='flex flex-col gap-6'>
                        <div className='flex justify-between items-center'>
                            <p className={`text-lg font-semibold inter-font text-slate-800 leading-[18px]`}>Delete Document</p>
                            <svg
                        ...
                        <div className='flex flex-col gap-[6px] '>
                            <p className={`text-base font-semibold inter-font text-slate-800 leading-[19px]`}>Are you sure you want to delete document </p>
                        ...
                        <div className='flex justify-end gap-4'>
                            ...
                            <ButtonPrimary label={'Delete'} padding={'py-3 px-6'} textSize={'text-sm'} deleteModalBg={true} />
                        </div>
                    </div>
