    ...
    return (
        <div className="relative z-0 max-w-[356px] w-full group">
            <input
                ...
                className="text-sm max-w-[356px] h-[56px] text-left relative px-4 py-3 w-full border rounded-md text-zinc-400 leading-[100%] border-navborder outline-none"
                type="text"
                placeholder={`${placeholder}`}
            />
            <svg
                className="absolute svg-theme right-3 z-10 top-5 cursor-pointer "
                width={16}
                height={16}
                viewBox="0 0 16 16"
                fill="none"
