...
const MapModal = ({ setModal, detailsModal, theme, compName }) => {
  useEffect(() => {
    ...
    >
      <div id="crypto-modal" tabIndex="-1" aria-hidden="true" className="">
        <div className="relative w-full h-full">
          <div className="relative  bg-summary-cards  flex flex-col shadow ">
            <button
              onClick={() => {
                setModal(false);
              }}
                          ...
                          >
                            ...
                            {detailsModal?.evidenceMaterial.map((item, id) => {
                              return (
                                <span
                                  key={id}
                                  className="flex flex-col font-normal text-xs "
                                >
                                  {item}
                                </span>
                              );
